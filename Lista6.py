...
def zad1():
    ...
    print(f"Zadanie 1: Czas potrzebny do rozpędzenia: {time:.2f} s")
...
print(f"przybliżenie harmoniczne: {h_approx:.6f}")
...
print("\nZad 7")
print(f"Najdokładniejsze przybliżenie f'(0.2) wynosi: {f_prime_0_2:.6f}"," drga: ",ffprim)
