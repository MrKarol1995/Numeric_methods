...
print(f"Współczynniki aproksymacji: a = {a4:.3f}, b = {b4:.3f}, c={c4:.3f}")
...
print(f"Interpolowane wartości dla T = {T_query} (metoda własna): {mu_lagrange_approximated}")
...
plt.plot(T_range, cubic_poly(T_range), label="Aproksymacja ", color="red")
plt.title("Zadanie 5: Aproksymacja lepkości")
...
print("Wielomiany metodą własną")
...
error2 = quadratic_vals-linear_vals
ssd= np.std(error2)
print("Błąd", ssd)
# Punkty danych
...
# Interpolacja Lagrange'a
plt.plot(x_vals, lagrange_vals, label='Interpolacja', color='blue', linestyle='--')
